...
/**
 * <code>HttpBasic</code> service interface.
 * <p>This interface act as a facade to the needed <code>HttpBasic</code> "policies" interfaces,
 * adding integration to GeoServer Security Provider.
 *
 */
public interface HttpBasicService {

    /**
     */
    void initializeFromConfig(String serverUrl);
