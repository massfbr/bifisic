...
const RecordItem = React.createClass({
    ...
    addLayer(wms) {
        ...
        // add epsg 3857 because the gs hazo publishes in 3857 but it does not declaires 3857
        if (allowedSRS && !CoordinatesUtils.isAllowedSRS(this.props.crs, allowedSRS)) {
