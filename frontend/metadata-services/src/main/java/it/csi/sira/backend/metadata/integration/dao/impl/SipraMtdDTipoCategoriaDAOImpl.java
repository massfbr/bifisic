...
public class SipraMtdDTipoCategoriaDAOImpl extends GenericDAO<SipraMtdDTipoCategoria> implements SipraMtdDTipoCategoriaDAO {
	...
	private final static String QUERY_PRIMARY_KEY = 
		"select * from bifisic_mtd_d_type_category where id_category_type = :id_category_type";
	
	private final static String QUERY_INSERT = 
		"insert into bifisic_mtd_d_type_category(id_category_type,des_category_type) values(:id_category_type,:des_category_type)";

	private final static String QUERY_UPDATE = 
		"update bifisic_mtd_d_type_category set des_category_type = :des_category_type  where id_category_type = :id_category_type";

	private final static String QUERY_DELETE = 
		"delete from bifisic_mtd_d_type_category where  id_category_type = :id_category_type";

	private final static String SQL_COUNT_ALL = 
		"select count(*) from bifisic_mtd_d_type_category";
	...
	public String getTableName(){
		return "bifisic_mtd_d_type_category";
	}

	@Override
	public String getSqlSelect() {
		return "select * from bifisic_mtd_d_type_category";
	}
	...
	public java.util.Map<String, Object> getValuesForInsert(SipraMtdDTipoCategoria sipraMtdDTipoCategoria) {
		java.util.Map<String, Object> map = new java.util.HashMap<String, Object>();
		map.put("id_category_type", sipraMtdDTipoCategoria.getIdTipoCategoria());
		map.put("des_category_type", sipraMtdDTipoCategoria.getDesTipoCategoria());
		return map;
	}
	...
	private static void populateBean(ResultSet rs, SipraMtdDTipoCategoria sipraMtdDTipoCategoria) throws SQLException {
		...
		sipraMtdDTipoCategoria.setIdTipoCategoria(rs.getInt("id_category_type")); // java.lang.Integer
		if ( rs.wasNull() ) { sipraMtdDTipoCategoria.setIdTipoCategoria(null); }; // not primitive number => keep null value if any
		sipraMtdDTipoCategoria.setDesTipoCategoria(rs.getString("des_category_type")); // java.lang.String
	}
