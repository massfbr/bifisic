...
public class SipraMtdTStoricoMtdCswDAOImpl extends GenericDAO<SipraMtdTStoricoMtdCsw> implements SipraMtdTStoricoMtdCswDAO {
	...
	private final static String QUERY_INSERT = 
		"insert into bifisic_mtd_t_history_mtd_csw(id_metadata_history,dc_identifier,title,text_abstract,metadata_type,url_metadata_calc,bound_box_crs,bound_box_lower_corner,bound_box_upper_corner) values(:id_metadata_history,:dc_identifier,:title,:text_abstract,:metadata_type,:url_metadata_calc,:bound_box_crs,:bound_box_lower_corner,:bound_box_upper_corner)";

	private final static String QUERY_UPDATE = 
		"update bifisic_mtd_t_history_mtd_csw set dc_identifier = :dc_identifier, title = :title, text_abstract = :text_abstract, metadata_type = :metadata_type, url_metadata_calc = :url_metadata_calc, bound_box_crs = :bound_box_crs, bound_box_lower_corner = :bound_box_lower_corner, bound_box_upper_corner = :bound_box_upper_corner  where id_metadata_history = :id_metadata_history";
	...
	public java.util.Map<String, Object> getValuesForInsert(SipraMtdTStoricoMtdCsw sipraMtdTStoricoMtdCsw) {
		...
		map.put("title", sipraMtdTStoricoMtdCsw.gettitle());
		...
		map.put("url_metadata_calc", sipraMtdTStoricoMtdCsw.getUrlMetadatoCalc());
	...
	private static void populateBean(ResultSet rs, SipraMtdTStoricoMtdCsw sipraMtdTStoricoMtdCsw) throws SQLException {
		...
		sipraMtdTStoricoMtdCsw.settitle(rs.getString("title")); // java.lang.String
		...
		sipraMtdTStoricoMtdCsw.setUrlMetadatoCalc(rs.getString("url_metadata_calc")); // java.lang.String
