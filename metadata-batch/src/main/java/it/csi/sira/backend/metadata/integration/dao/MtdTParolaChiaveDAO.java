...
/**
 * MtdTParolaChiave DAO interface
 * 
 * @author Telosys Tools
 */
public interface MtdTParolaChiaveDAO {
	...
	public List<MtdTParolaChiave> findAll();
	
	public List<MtdTParolaChiave> findByCriteria(java.util.Map<String, Object> params);
	public List<MtdTParolaChiave> findByCriteria(MapSqlParameterSource params);
	...
	public List<MtdTParolaChiave> findByGenericCriteria(String query, MapSqlParameterSource params);
	
	public void insert(MtdTParolaChiave bean);

	public void update(MtdTParolaChiave bean);
